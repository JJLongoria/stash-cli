...
export default class Create extends BaseCommand {
    ...
    static examples = [
        `$ stash projects:repos:pulls:comments:update -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --pull 1234 --coment 4567 --text "Text to update" --version 2 --csv`,
        `$ stash projects:repos:pulls:comments:update -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --pull 1234 --coment 4567 --text "Text to update" --version 2 --json`,
        `$ stash projects:repos:pulls:comments:update -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --pull 1234 --coment 4567 --text "Text to update" --version 2 `,
    ];
    static flags = {
        ...BaseCommand.flags,
        csv: BuildFlags.csv,
