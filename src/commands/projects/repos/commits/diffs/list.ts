...
export default class List extends BaseCommand {
    ...
    static examples = [
        `$ stash projects:repost:commits:diffs:list -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --commit "a62ajdu128" --context-lines 5 --csv`,
        `$ stash projects:repost:commits:diffs:list -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --commit "a62ajdu128" --src "path/to/src/path" --'without-comments' --json`,
        `$ stash projects:repost:commits:diffs:list -a MyStashAlias --project "ProjectKey" --slug "MyRepoSlug" --commit "a62ajdu128" --path "path/to/file" --limit 30`,
    ];
    static flags = {
        ...BaseCommand.flags,
        csv: BuildFlags.csv,
